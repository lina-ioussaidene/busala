...
export default function Programs() {
  ...
  const programs = [
    ...
    },
    {
      ...
      title: 'برنامج ألفة للتأهيل الأسر',
    ...
    },
    {
      ...
      desc: 'ويقوم على نظام الدفعات (Cohorts) وهو مسار معرفي، تربوي، ثقافي، سلوكي حضاري يروم إلى تأهيل وتمكين الإنسان وبناء شخصية إنسانية رسالية حضارية متوازنة تمضي في الحياة برسالةٍ تُحسن حملها وتترك بها أثرًا ينفع المجتمع ويخدم الأمة، حيث يتم تأطير المستفيدين ببرامج ودورات محددة المدة بشكل متدرج ومنهجي وفق مراحل تنطلق من التأهيل وصولاً إلى التمكين، لضمان التغيير الحقيقي الفاعل في الفكر والسلوك والمهارات، هذا المسار لا يقدّم معرفة فقط، بل يبني إنسانًا يعيش وعيه وقيمه وممارسته الرسالية في الواقع.',
      image: 'https://images.unsplash.com/photo-1510530059226-4ae1a2b220ff?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
      details: {
        objectives: [
          'تأهيل وتمكين الإنسان بشكل متكامل',
          'بناء شخصية رسالية حضارية متوازنة',
          'تحقيق التغيير الحقيقي في الفكر والسلوك',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
           انطالقا من رؤيتنا في التأهيل والتمكين ، يقدم مركز بوصلة مجموعة من المشاريع
النوعية التي تستهدف بناء اإلنسان الرسالي من مختلف الجوانب الفكرية ،اإليمانية ،

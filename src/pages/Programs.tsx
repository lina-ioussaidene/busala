...
export default function Programs() {
  ...
  const programs = [
    ...
    },
    {
      ...
      desc: 'تشعر أن التحديات الأسرية اليوم لم تعد بسيطة مع سوء الفهم، والضغوط اليومية، و الإختلاف  في أساليب التربية، عدم تكامل أدوار الوالدية، وصعوبة إدارة العلاقة الزوجية، وتفاقم مشاكل الأبناء وتحدياتهم مما يؤثر على استقرار الأسرة وهدوئها؟ المشكل ليس في الأسرة نفسها، بل في غياب التأهيل الذي يمنح أفرادها أدوات الفهم، التواصل، وإدارة الحياة المشتركة بوعي واتزان. من هنا يأتي برنامج ألفة للتأهيل الأسري، وهو برنامج تدريبي شامل يأهل المقبلين على الزواج والمتزوجين لبناء حياة زوجية مستقرة، من خلال تنمية مهارات التواصل وحل الخلافات، وتربية الأبناء والتعامل مع تحدياتهم العمرية وبناء أسرة مستقرة رسالية بأساليب تربوية حضارية.',
